...
public class Principal extends javax.swing.JFrame {
    ...
    public void LoadTableDep(){
        ...
        for (Departamento departamento : ListaDep) {
            Object[] linha = new Object[]{departamento.getCodigo(),
    ...
    public void LoadTableFunc(){
        ...
        for (Funcionario funcionario : ListaFunc) {
            Object[] linha = new Object[]{funcionario.getMatricula(),
                    funcionario.getNome(),
                    funcionario.getDep().getNome()};
            modelo.addRow(linha);
        }
    ...
    public void LoadCBDep(){
        ...
        for (Departamento departamento : ListaDep) {
            cb_func_deps.addItem(departamento.getNome());
        }
    }
    ...
    private void initComponents() {
        ...
        btn_dep_salvar.addActionListener(this::btn_dep_salvarActionPerformed);

        btn_dep_cancelar.setText("Cancelar");
        btn_dep_cancelar.addActionListener(evt -> btn_dep_cancelarActionPerformed());
        ...
        btn_dep_novo.addActionListener(evt -> btn_dep_novoActionPerformed());

        btn_dep_editar.setText("Editar");
        btn_dep_editar.addActionListener(evt -> btn_dep_editarActionPerformed());

        btn_dep_excluir.setText("Excluir");
        btn_dep_excluir.addActionListener(evt -> btn_dep_excluirActionPerformed());
        ...
        btn_func_editar.addActionListener(evt -> btn_func_editarActionPerformed());
        ...
        btn_func_excluir.addActionListener(evt -> btn_func_excluirActionPerformed());
        ...
        btn_func_salvar.addActionListener(evt -> btn_func_salvarActionPerformed());

        btn_func_cancelar.setText("Cancelar");
        btn_func_cancelar.addActionListener(evt -> btn_func_cancelarActionPerformed());
        ...
        btn_func_novo.addActionListener(evt -> btn_func_novoActionPerformed());
    ...
    private void btn_dep_novoActionPerformed() {//GEN-FIRST:event_btn_dep_novoActionPerformed
    ...
    private void btn_dep_cancelarActionPerformed() {//GEN-FIRST:event_btn_dep_cancelarActionPerformed
        c_dep_codigo.setText("");
        c_dep_nome.setText("");
        modoDep = "Navegar";
        ManipulaInterfaceDep();
    ...
    private void tbl_dep_dptsMouseClicked() {//GEN-FIRST:event_tbl_dep_dptsMouseClicked
        int index = tbl_dep_dpts.getSelectedRow();
    ...
    private void btn_dep_editarActionPerformed() {//GEN-FIRST:event_btn_dep_editarActionPerformed
        modoDep = "Editar";
        ManipulaInterfaceDep();
    }//GEN-LAST:event_btn_dep_editarActionPerformed

    private void btn_dep_excluirActionPerformed() {//GEN-FIRST:event_btn_dep_excluirActionPerformed
        int index = tbl_dep_dpts.getSelectedRow();
        if(index>=0 && index<ListaDep.size()){
    ...
    private void btn_func_editarActionPerformed() {//GEN-FIRST:event_btn_func_editarActionPerformed
        modoFunc = "Editar";
        ManipulaInterfaceFunc();
    }//GEN-LAST:event_btn_func_editarActionPerformed

    private void tbl_func_funcsMouseClicked() {//GEN-FIRST:event_tbl_func_funcsMouseClicked

    }//GEN-LAST:event_tbl_func_funcsMouseClicked

    private void btn_func_excluirActionPerformed() {//GEN-FIRST:event_btn_func_excluirActionPerformed
        modoFunc = "Navegar";
        ManipulaInterfaceFunc();
    }//GEN-LAST:event_btn_func_excluirActionPerformed

    private void btn_func_salvarActionPerformed() {//GEN-FIRST:event_btn_func_salvarActionPerformed
    ...
    private void btn_func_cancelarActionPerformed() {//GEN-FIRST:event_btn_func_cancelarActionPerformed
        modoFunc = "Navegar";
        ManipulaInterfaceFunc();
    }//GEN-LAST:event_btn_func_cancelarActionPerformed

    private void btn_func_novoActionPerformed() {//GEN-FIRST:event_btn_func_novoActionPerformed
        modoFunc = "Novo";
        ManipulaInterfaceFunc();
